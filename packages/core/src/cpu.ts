...
import { bit, byte, word, Bit, Byte, Word } from './sized';
import { Registers, ByteRegister, WordRegister, Flag } from './cpu-registers';
import {
  addBytes,
  subtractBytes,
  addWords,
...
class Instruction {
  constructor(private opcode: number, private name: string, public readonly invoke: (cpu: CPU) => Duration) {}
