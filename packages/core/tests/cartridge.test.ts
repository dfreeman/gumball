...
describe('Cartridge', () => {
  test.concurrent('loading a simple ROM', async () => {
    let { rom } = await asm`
  ...
  test.concurrent('with CGB and SGB support', async () => {
  ...
  test.concurrent('with invalid header checksum', async () => {
  ...
  test.concurrent('with invalid logo bytes', async () => {
